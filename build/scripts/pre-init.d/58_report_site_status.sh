...
then
  ...
  sed -i "s|'host' => '.*',|'host' => '$DRUPAL_DB_HOSTNAME',|g" "$DRUPAL_ROOT/sites/default/settings.php"
  sed -i "s|'port' => '[0-9]\{2,4\}',|'port' => '$DRUPAL_DB_PORT',|g" "$DRUPAL_ROOT/sites/default/settings.php"
else
