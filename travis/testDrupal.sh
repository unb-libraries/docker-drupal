#!/usr/bin/env bash
# Runs Drupal tests.
docker exec dockerdrupal_drupal_1 drush --root=/app/html --uri=default en --yes --pm-force simpletest
...
docker exec dockerdrupal_drupal_1 drush --root=/app/html --uri=default pm-uninstall --yes --pm-force simpletest
