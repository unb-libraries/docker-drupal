...
RUN apk -U upgrade && apk --update add php7-mysqlnd php7-session php7-pdo php7-pdo_mysql php7-pcntl php7-dom php7-posix php7-ctype php7-gd php7-xml php7-opcache php7-mbstring git unzip mysql-client rsync && \
  rm -f /var/cache/apk/*
